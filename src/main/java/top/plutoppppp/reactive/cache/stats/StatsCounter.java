...
import top.plutoppppp.reactive.cache.ReactiveCache;

/**
 * Accumulates statistics during the operation of a {@link ReactiveCache} for presentation by
 * {@link ReactiveCache#stats}. This is solely intended for consumption by {@code Cache} implementors.
 *
 * @since 10.0
 */
public interface StatsCounter {
     ...
     * blocking on the load. Multiple concurrent calls to {@link ReactiveCache} lookup methods with the same
